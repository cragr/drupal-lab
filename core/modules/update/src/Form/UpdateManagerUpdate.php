...
class UpdateManagerUpdate extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    foreach ($project_data as $name => $project) {
      ...
      $recommended_version_parser = ModuleVersion::createFromVersionString($recommended_release->getVersion());
      ...
      $recommended_version = [
        ...
        '#context' => [
          ...
          'release_link' => $recommended_release->getUrl(),
      ...
      // separate table. If it's not defined, it means we can't determine
