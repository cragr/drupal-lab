...
class Sql extends PluginBase implements MigrateIdMapInterface, ContainerFactoryPluginInterface, HighestIdInterface {
  ...
  public function prepareUpdate() {
    @trigger_error('Sql::prepareUpdate() is deprecated in drupal:9.2.0 and is removed from drupal:10.0.0. Use \Drupal\Tests\migrate\Traiths\MigrateTestTrait::prepareUpdate() in tests. See https://www.drupal.org/node/3188673', E_USER_DEPRECATED);
