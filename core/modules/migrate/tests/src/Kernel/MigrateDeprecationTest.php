...
class MigrateDeprecationTest extends KernelTestBase {
  ...
  public function testNullIdMapPrepareUpdateDeprecation(): void {
    ...
    $this->expectDeprecation('NullIdMap::prepareUpdate() is deprecated in drupal:9.2.0 and is removed from drupal:10.0.0. Use \Drupal\Tests\migrate\Traiths\MigrateTestTrait::prepareUpdate() in tests. See https://www.drupal.org/node/3188673');
    $map->prepareUpdate();
  }
  ...
  public function testSqlPrepareUpdateDeprecation(): void {
    ...
    $this->expectDeprecation('Sql::prepareUpdate() is deprecated in drupal:9.2.0 and is removed from drupal:10.0.0. Use \Drupal\Tests\migrate\Traiths\MigrateTestTrait::prepareUpdate() in tests. See https://www.drupal.org/node/3188673');
    $map->prepareUpdate();
  }
