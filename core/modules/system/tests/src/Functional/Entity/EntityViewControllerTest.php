...
class EntityViewControllerTest extends BrowserTestBase {
  ...
  public function testFieldItemAttributes() {
    ...
    $this->drupalGet('entity_test/' . $entity->id());
    $this->assertSession()->elementExists('xpath', '//div[@data-field-item-attr="foobar"]/p');
    ...
    $this->drupalGet('entity_test/' . $entity->id());
    $this->assertSession()->elementExists('xpath', '//div[@data-field-item-attr="foobar" and @property="schema:text"]/p');
