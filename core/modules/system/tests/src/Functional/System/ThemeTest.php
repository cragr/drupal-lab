...
class ThemeTest extends BrowserTestBase {
  ...
  public function testThemeSettings() {
    ...
    foreach ($supported_paths as $input => $expected) {
      ...
      $this->assertEquals($implicit_public_file, $elements[0]->getText());
      $this->assertEquals($explicit_file, $elements[1]->getText());
      $this->assertEquals($local_file, $elements[2]->getText());
