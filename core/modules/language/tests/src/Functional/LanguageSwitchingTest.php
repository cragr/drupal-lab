...
class LanguageSwitchingTest extends BrowserTestBase {
  ...
  protected function doTestLanguageLinkActiveClassAuthenticated() {
    ...
    $this->assertArrayHasKey(0, $links, 'A link generated by :function to the current :language page with langcode :langcode has the correct attributes that will allow the drupal.active-link library to mark it as active.', [':function' => $function_name, ':language' => $current_language, ':langcode' => $langcode]);
    ...
    $this->assertArrayHasKey(0, $links, 'A link generated by :function to the current :language page with langcode :langcode has the correct attributes that will allow the drupal.active-link library to NOT mark it as active.', [':function' => $function_name, ':language' => $current_language, ':langcode' => $langcode]);
  ...
  protected function doTestLanguageLinkActiveClassAnonymous() {
    ...
    $this->assertArrayHasKey(0, $links, 'A link generated by :function to the current :language page with langcode :langcode is marked active.', [':function' => $function_name, ':language' => $current_language, ':langcode' => $langcode]);
    ...
    $this->assertArrayHasKey(0, $links, 'A link generated by :function to the current :language page with langcode :langcode is NOT marked active.', [':function' => $function_name, ':language' => $current_language, ':langcode' => $langcode]);
