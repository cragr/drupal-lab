...
class ManageFieldsFunctionalTest extends BrowserTestBase {
  ...
  public function testExternalDestinations() {
    ...
    $this->assertSession()->addressEquals('admin/structure/types/manage/article/fields/node.article.body/storage');
    $this->assertSession()->urlQuerystringEquals('admin/structure/types/manage/article/fields/node.article.body/storage?destinations%5B0%5D=http%3A//example.com');
    $this->assertSession()->statusCodeEquals(200);
