...
class FieldUITest extends FieldTestBase {
  ...
  public function testHandlerUI() {
    ...
    $this->assertEquals(['text_default', 'text_trimmed'], $options, 'The text formatters for a simple text field appear as expected.');
  ...
  public function testHandlerUIAggregation() {
    ...
    $this->assertEquals(['format', 'value'], $options, 'The expected sort field options were found.');
  }
