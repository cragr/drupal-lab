...
class BasicSettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['live_preview']['options']['ui_show_additional_queries'] = [
      ...
      '#description' => $this->t("The site has the potential to run many queries while a view is being rendered. Checking this box will display every query run during view render as part of the live preview."),
