  ...
  public function buildOptionsForm(&$form, FormStateInterface $form_state) {
    ...
    switch ($section) {
      ...
      case 'link_display':
        ...
        $description = [];
        $description[] = [
          '#markup' => $this->t('A website path or external URL the more link will point to. Note that this will override the link display setting above.'),
        ];
        if (!empty($options)) {
          $description[] = [
            '#prefix' => '<p>',
      ...
      case 'exposed_block':
        ...
        $form['description'] = [
          '#markup' => '<div class="js-form-item form-item description">' . $this->t('If set, any exposed widgets will not appear with this view. Instead, a block will be made available to the website block administration system, and the exposed form will appear there. Note that this block must be enabled manually, Views will not enable it for you.') . '</div>',
        ];
        $form['exposed_block'] = [
          '#type' => 'radios',
