  ...
  public function buildOptionsForm(&$form, FormStateInterface $form_state) {
    ...
    if ($this->allowAdvancedRender()) {
      ...
      $form['alter']['path'] = [
        ...
        '#description' => $this->t('The website path or absolute URL for this link. You may enter data from this view as per the "Replacement patterns" below.'),
        '#states' => [
          'visible' => [
      ...
      $form['alter']['more_link_path'] = [
        ...
        '#description' => $this->t('This can be an internal website path such as node/add or an external URL such as "https://www.drupal.org". You may use the "Replacement patterns" above.'),
        '#states' => [
          'visible' => [
            ':input[name="options[alter][trim]"]' => ['checked' => TRUE],
            ':input[name="options[alter][more_link]"]' => ['checked' => TRUE],
