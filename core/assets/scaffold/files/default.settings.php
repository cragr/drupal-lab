 ...
 * may uncomment this setting and set it to TRUE to allow an insecure fallback
 * to HTTP. Note that doing so will open your site up to a potential
 * man-in-the-middle attack. You should instead attempt to resolve the issues
