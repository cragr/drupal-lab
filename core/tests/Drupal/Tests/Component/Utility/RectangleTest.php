...
class RectangleTest extends TestCase {
   ...
   *
   * @dataProvider providerPhp7025RotateDimensions
   */
   ...
   * @dataProvider providerPhp7025RotateDimensions
   */
  public function testGdRotate($width, $height, $angle, $exp_width, $exp_height) {
   ...
   *
   * This dataset sample was generated by running, on PHP 7.0.25 with libgd
   * 2.2.2, the function below:
   ...
   */
  public function providerPhp7025RotateDimensions() {
