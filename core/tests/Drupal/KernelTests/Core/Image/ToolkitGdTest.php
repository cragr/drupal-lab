...
class ToolkitGdTest extends KernelTestBase {
  ...
  public function colorsAreEqual($color_a, $color_b) {
    @trigger_error(__METHOD__ . '() is deprecated in drupal:9.2.0 and is removed from drupal:10.0.0. Use ::assertColorsAreEqual() instead. See https://www.drupal.org/node/TODO', E_USER_DEPRECATED);
