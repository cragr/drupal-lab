...
class UserAgentLegacyTest extends BrowserTestBase {
  ...
  public function testDrupalTestUa() {
    $this->expectDeprecation('drupal_valid_test_ua() is deprecated in drupal:9.2.0 and is removed from drupal:10.0.0. Use \Drupal\Core\Test\UserAgent::validate(). See https://www.drupal.org/node/3044173');
