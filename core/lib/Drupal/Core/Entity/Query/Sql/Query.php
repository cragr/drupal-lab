...
class Query extends QueryBase implements QueryInterface {
  ...
  protected function prepare() {
    ...
    if (is_null($this->accessCheck)) {
      ...
      @trigger_error($e->getTraceAsString() . 'Omitting to explicitly specify whether access should be checked on an entity query is deprecated in drupal:9.2.0. An error will be thrown from drupal:10.0.0. See https://www.drupal.org/node/3201242', E_USER_DEPRECATED);
    }
    if ($this->accessCheck) {
