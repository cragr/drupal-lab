...
interface EntityTypeInterface extends PluginDefinitionInterface {
  ...
  /**
   * Gets the entity types for which this entity provides bundles.
   *
   ...
   *
   * @return string[]|null
   *   The entity types for which this entity provides bundles, or NULL if does
   ...
   *
   * @see https://www.drupal.org/node/3191815
   */
