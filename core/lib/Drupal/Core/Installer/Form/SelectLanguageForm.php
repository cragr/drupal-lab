...
class SelectLanguageForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $install_state = NULL) {
    ...
    $form['help'] = [
      ...
      '#markup' => '<p>Translations will be downloaded from the <a href="http://localize.drupal.org/download" target="_blank">Drupal Translation website</a>. If you do not want this, select <a href="' . $link_to_english . '">English</a>.</p>',
      '#states' => [
        'invisible' => [
